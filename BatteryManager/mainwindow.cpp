...
{
    bool is_there_battery = bm->isBatteryInSystem();
    ...
    if (is_there_battery){
        ...
        if (ui->remaning_time_work->text() == "От сети" &&
            ...
            ui->remaning_time_work_value->setText("..."); // стрёмно, потому что в прошлой версии даже без _value ставило точки куда нужно
        }
        ...
        ui->AC_status_value->setText("Батарея отсутствует");

        ui->battery_charge_level_value->setText("Батарея отсутствует");

        ui->battery_type_value->setText("Батарея отсутствует");

        ui->current_capacity_value->setText("Батарея отсутствует");

        ui->max_capacity_value->setText("Батарея отсутствует");

        ui->designed_capacity_value->setText("Батарея отсутствует");

        ui->cycles_value->setText("Батарея отсутствует");

        ui->remaning_time_work_value->setText("Батарея отсутствует");

        ui->remaning_time_charge_value->setText("Батарея отсутствует");

        ui->power_saving_value->setText("Батарея отсутствует");
